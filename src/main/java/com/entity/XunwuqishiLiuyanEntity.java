...
public class XunwuqishiLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XunwuqishiLiuyanEntity() {

	}

	public XunwuqishiLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "xunwuqishi_id")
    ...
    @TableField(value = "xunwuqishi_liuyan_text")
    ...
    public String toString() {
        return "XunwuqishiLiuyan{" +
            ", id=" + id +
            ", xunwuqishiId=" + xunwuqishiId +
            ", yonghuId=" + yonghuId +
            ", xunwuqishiLiuyanText=" + xunwuqishiLiuyanText +
            ", replyText=" + replyText +
